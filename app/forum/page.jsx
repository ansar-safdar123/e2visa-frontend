  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-[#40433F] px-4">
      ...
      <div className="relative z-10 text-center max-w-3xl mx-auto">
        ...
        <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">Community Forum Coming Soon!</h1>
        <p className="text-lg md:text-xl text-white/90 mb-12">
          We're building a vibrant community platform for discussions and knowledge sharing. Join us soon!
        </p>
